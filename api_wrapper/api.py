...
_API_DIR = '/home/pi/HROS1-Framework/Linux/project/HRI_project/api_wrapper'
...
MoveHeadByAngle = _apiwrapper.MoveHeadByAngleJS

MoveHeadByAngle.argtypes = [c_double, c_double]

MoveHeadByAngle.restype  = None
